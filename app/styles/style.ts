export const style = {
	...
	button:
		"flex flex-row text-white  justify-center items-center py-3 px-6 rounded-full cursor-pointer bg-[#2190ff] min-h-[45px] w-full text-[16px] font-Poppins font-semibold",
	profileButton:
